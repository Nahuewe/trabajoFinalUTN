...
const Form = () => {
    ...
    //     emailjs.sendForm('Gmail', 'template_ep0vv1q', e.target, 'u1HZcSHJOPhUccD57')
    //         .then((result) => {
    //             console.log(result.text);
    //         }, (error) => {
    //             console.log(error.text);
    //         });
    // };  Todo esto es parte de EmailJS
            ...
            <div className="formulario-container">
                ...
                orderId
                    ...
                    <div>
                        ...
                        <form /* ref={form} */ onSubmit={sendOrder} /* onSubmit={sendEmail} */ onChange={handleChange}>
                            ...
                            <div className="dato-form">
                                <span className="obligatorio">*</span>
                                <input style={{textTransform: 'capitalize'}} autocomplete="off" name="surname" defaultValue={formData.surname} required placeholder="Apellido" title="SIN ESPACIOS, NUMEROS, NI SIMBOLOS"/>
                            </div>
                            ...
                            {/* <form onClick={sendEmail}><button className="ticket" disabled={ !formData.name || !formData.surname || !formData.phone || !formData.email || !formData.adress || cart.length === 0}>Ticket</button></form>  Acá se supone que intentaba que funcion EmailJS */}
                        </form>
                    </div>
                }
            </div>
